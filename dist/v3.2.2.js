...
var _createComponent = __webpack_require__(14);
      ...
      if (template) {
        ...
        if (typeof template === 'string') {
          if (template.charAt(0) === '#') {
            ...
            /* istanbul ignore if */
            if (!template) {
              (0, _index3.warn)('Template element not found or is empty: ' + options.template, this);
            }
          }
        } else if (template.nodeType) {
          template = template.innerHTML;
        } else {
          (0, _index3.warn)('invalid template option:' + template, this);
          return this;
        }
      } else if (el) {
        // 从dom节点里边取
...
function mountComponent(vm, el) {
  ...
  vm._watcher = new _watcher2.default(vm, updateComponent, _index3.noop);
...
function query(el) {
  if (typeof el === 'string') {
    ...
    if (!selected) {
      (0, _index3.warn)('Cannot find element: ' + el);
...
var _renderList = __webpack_require__(25);

var _checkKeycodes = __webpack_require__(24);
...
function initRender(vm) {
  ...
  vm._c = function (a, b, c) {
    return (0, _vnode.createElementVNode)(vm, a, b, c);
  };
}
...
exports.initComponentAndMount = initComponentAndMount;
...
function createComponent(Ctor, data, context, children, tag) {
  ...
  // 生成一个特殊的vnode 带有
  var vnode = new _vnode2.default('vue-component-' + Ctor.cid + (name ? '-' + name : ''), data, undefined, undefined, undefined, context, { Ctor: Ctor, tag: tag, children: children });
  return vnode;
}
...
function initComponentAndMount(vnode, parentElm, refElm) {
...
var _htmlParser = __webpack_require__(18);

var _textParser = __webpack_require__(20);

var _debug = __webpack_require__(2);

var _attrs = __webpack_require__(13);
...
var _normalizeChildren = __webpack_require__(34);
...
var _nodeOps = __webpack_require__(35);
...
var _domProps = __webpack_require__(31);
...
function createComponent(vnode, parentElm, refElm) {
  if (isDef(vnode.componentOptions)) {
    ...
    (0, _createComponent.initComponentAndMount)(vnode, parentElm, refElm);
