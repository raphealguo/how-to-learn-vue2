...
var _props = __webpack_require__(35);
...
var _dep = __webpack_require__(15);
...
var _patch = __webpack_require__(41);
...
var _resolveSlots = __webpack_require__(12);

var _index5 = __webpack_require__(0);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var activeInstance = exports.activeInstance = null; // 当前正在处理的vm对象
...
function lifecycleMixin(Vue) {
  ...
  Vue.prototype._update = function () {
    ...
    exports.activeInstance = activeInstance = prevActiveInstance; //恢复指向
  ...
  Vue.prototype.$destroy = function () {
    ...
    if (parent && !parent._isBeingDestroyed) {
      (0, _index5.remove)(parent.$children, vm);
    }
...
function updateChildComponent(vm, propsData, parentVnode, renderChildren) {
...
var _attrs = __webpack_require__(18);
...
var _renderList = __webpack_require__(29);

var _renderSlot = __webpack_require__(30);

var _checkKeycodes = __webpack_require__(28);
...
var _htmlParser = __webpack_require__(22);

var _textParser = __webpack_require__(24);
...
function processSlot(el) {
  if (el.tag === 'slot') {
    ...
    if (el.key) {
      (0, _debug.warn)('`key` does not work on <slot> because slots are abstract outlets ' + 'and can possibly expand into multiple elements. ' + 'Use the key on a wrapping element instead.');
    }
  } else {
    // 父组件引用：<div slot="xxx">
 ...
 */
function renderSlot(name, fallback) {
  var slotNodes = this.$slots[name]; //从当前的vm.$slots找到父亲里边声明的 <div slot="xxx">等vnode
...
function createComponent(Ctor, data, context, children, tag) {
  ...
  // 生成一个特殊的vnode 带有
  var vnode = new _vnode2.default('vue-component-' + Ctor.cid + (name ? '-' + name : ''), data, undefined, undefined, undefined, context, { Ctor: Ctor, propsData: propsData, listeners: listeners, tag: tag, children: children // children是父亲传递给子组件的内容，子组件需要把这些节点插到对应的slot里边去
  });
  return vnode;
}
...
function prepatch(oldVnode, vnode) {
  ...
  (0, _lifecycle.updateChildComponent)(child, options.propsData, vnode, // new parent vnode
...
var _createComponent = __webpack_require__(36);
...
var _normalizeChildren = __webpack_require__(39);
...
var _nodeOps = __webpack_require__(48);
...
var _attrs = __webpack_require__(44);
...
var _domProps = __webpack_require__(46);
...
var platformModules = [_attrs2.default, _class2.default, _events2.default, _domProps2.default];

var modules = platformModules.concat(_index2.default);
